...
// Get Todo
$data_todo = query("SELECT * FROM todo WHERE status = 'Planning' ORDER BY id DESC");
// Add Todo
...
<head>
  ...
  <title>Todo List - Planning</title>
</head>
        ...
        <div class="col-md-6 mb-3 col-12 col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <span class="position-absolute bg-primary" style="top: 13px; right: 69px; width: 18px; height: 18px; transform: rotate(45deg);"></span>
              <span class="position-absolute bg-primary text-white px-2" style="top: 10px; right: 0;">Planning</span>
              <div class="row">
                <div class="col-10">
                  <div class="d-grid">
                    <a href="detail.php?id=<?= $data["id"]; ?>" class="btn btn-warning" role="button">Detail</a>
                  </div>
                </div>
                <div class="col-2">
                  <a href="delete.php?id=<?= $data["id"]; ?>" class="btn btn-danger" role="button" onclick="return confirm('Apakah data ingin di hapus?')"><i class="fa-regular fa-trash-can"></i></a>
                </div>
              </div>
            </div>
          </div>
