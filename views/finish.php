...
// Get Todo
$data_todo = query("SELECT * FROM todo WHERE status = 'Finish' ORDER BY id DESC");
// Add Todo
        ...
        <div class="col-md-6 mb-3 col-12 col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <span class="position-absolute bg-danger" style="top: 13px; right: 64px; width: 18px; height: 18px; transform: rotate(45deg);"></span>
              <span class="position-absolute bg-danger text-white px-3" style="top: 10px; right: 0;">Finish</span>
              <div class="row">
                <div class="col-10">
                  <div class="d-grid">
